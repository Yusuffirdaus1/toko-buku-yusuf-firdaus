...
<div class="page-header">
    <h4>Edit: {{ Str::limit($book->title, 40) }}</h4>
    ...
    <form action="{{ route('admin.books.update', $book) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="price" class="form-control" value="{{ old('price', $book->price) }}" min="0" required>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="year" class="form-control" value="{{ old('year', $book->year) }}" min="1900" max="{{ date('Y') }}">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-8">
                <label class="form-label">Cover Buku (Kosongkan jika tidak diubah)</label>
                <input type="file" name="cover_image" class="form-control" accept="image/*" onchange="previewCover(this)">
                <img id="coverPreview" src="{{ $book->cover_url }}" class="mt-2 rounded-3" style="height: 100px; object-fit: cover;">
            </div>
            <div class="col-12">
