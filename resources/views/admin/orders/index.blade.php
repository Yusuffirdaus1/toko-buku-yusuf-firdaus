...
@section('content')
    <div class="page-header">
        ...
        <form class="d-flex gap-2">
            <select name="status" class="form-select form-select-sm rounded-3 fw-medium"
                style="min-width: 140px; cursor: pointer;" onchange="this.form.submit()">
                ...
                <tbody>
                    @forelse($orders as $order)
                        <tr>
                            ...
                            <td>
                                @if($order->sale_type === 'pos' || $order->payment_method === 'Kasir')
                                    <span class="badge bg-purple" style="background:#7c3aed">Kasir</span>
                                @else
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge bg-warning text-dark">
                                        {{ $order->payment_method === 'Kasir' ? 'Siapkan Uang' : 'Menunggu Bayar' }}
                                    </span>
                                @endif
                            </td>
